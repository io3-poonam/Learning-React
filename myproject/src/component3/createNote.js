...
console.log('note', note1)
    ...
    <div className=" main_note" onDoubleClick={dBClick}>
        <form className="form">
            {expand?
            <input name="title" value={note1.title} onChange={inputEventNote} id="input" type="text" placeholder="Title" autoComplete="off"/>:null}
            ...
            {expand?
            <button className="MuiButton-root" onClick={(pd)=>HandleBtnClick1(pd)}><AddIcon className="plus-sign"/> </button>:null}
